...
# 数据读取路径
Data_Read_PATH = "/home/sunysh/12Cancer/BRCA/10000-1-vcf/part5/train.Matrix"

# 模型保存的路径和文件名
MODEL_SAVE_PATH = "/home/sunysh/12Cancer/BRCA/10000-1-vcf/part5/Model"
...
def train():
    ...
    #TensorBoard
    writer = tf.summary.FileWriter("/home/sunysh/12Cancer/BRCA/10000-1-vcf/part5/Log", tf.get_default_graph())
    writer.close()
